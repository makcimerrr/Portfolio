---
title: ChatBocal
description: ChatBocal est un chatbot local propulsé par Ollama, avec plusieurs modèles LLM, et une application Next.js pour l'interface utilisateur et l'API backend.
date: 2025-03-14
image: /chatbocal.png?height=auto&width=auto
tags: ["Next.js", "TypeScript", "IA", "Docker", "Tailwind CSS", "PostgreSQL", "Ollama", "Drizzle ORM"]
github: https://github.com/makcimerrr/chatbocal
demo: https://chatbocal.vercel.app
featured: true
---
